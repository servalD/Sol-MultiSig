...
contract DeployDAOMultiSigWalletLocal is Script {
    function run() external {
        ...
        DAOMultiSigWallet wallet = new DAOMultiSigWallet(owners, 2);

        vm.stopBroadcast();

        console.log("DAOMultiSigWallet deployed locally at:", address(wallet));
        console.log("Owners:");
